-- Table: public.hs_prs_enota_rs

-- DROP TABLE public.hs_prs_enota_rs;

CREATE TABLE public.hs_prs_enota_rs
(
    enota numeric(9,0),
...
ALTER TABLE public.hs_prs_enota_rs
    OWNER to matej;

-- Index: hs_maticna_index

-- DROP INDEX public.hs_maticna_index;

CREATE INDEX hs_maticna_index
    ON public.hs_prs_enota_rs USING btree
